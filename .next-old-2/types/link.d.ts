...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    ...
    | `/admin/companies/${SafeSlug<T>}`
    | `/admin/requests/${SafeSlug<T>}`
    | `/admin/transfers/${SafeSlug<T>}`
    | `/candidate/invitations/${SafeSlug<T>}`
    | `/candidate/payments/${SafeSlug<T>}`
    | `/candidate/work-logs/${SafeSlug<T>}`
    | `/company/companies/${SafeSlug<T>}`
    | `/company/requests/${SafeSlug<T>}`
    | `/inspector/id-requests/${SafeSlug<T>}`
    | `/staff/candidates/${SafeSlug<T>}`
    | `/staff/interviews/${SafeSlug<T>}`
    | `/staff/requests/${SafeSlug<T>}`
