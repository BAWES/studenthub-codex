...
const sideClass: Record<string, string> = {
  top: "sheetContentTop",
  right: "sheetContentRight",
  bottom: "sheetContentBottom",
  left: "sheetContentLeft",
}
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn("sheetContent", sideClass[side], className)}
        {...props}
      >
        {children}
        {showCloseButton && (
          <SheetPrimitive.Close className="sheetClose">
            <XIcon />
...
function SheetBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("sheetBody", className)}
      {...props}
    />
  )
}
