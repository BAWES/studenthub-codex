...
/**
 * Schema for a single certificate item returned by list/get/create/update.
 */
...
/**
 * Schema for the listCertificates paginated result.
 */
...
/**
 * Schema for the deleteCertificate simple success result.
 */
export const certificateActionSuccessSchema = z.object({
  success: z.boolean(),
});
