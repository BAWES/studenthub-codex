    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          type="button"
          disabled={isPending}
          className="flex w-full items-center gap-1.5 rounded-md border border-border bg-transparent px-[10px] py-[4px] text-xs font-semibold text-muted-foreground min-h-[32px] cursor-default"
        >
