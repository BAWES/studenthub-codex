...
import {
  ...
  ArrowRightLeft, Calendar,   ArrowRightLeft, Calendar, Globe, GraduationCap
} from "lucide-react";
...
export function navForRole(role: Role): NavItem[] {
  if (role === "admin") {
    return [
      ...
      { label: "Requests", href: "/admin/requests", icon: FileCheck },,       { label: "Countries", href: "/admin/country", icon: Globe },
