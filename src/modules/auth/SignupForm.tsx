  ...
  if (isInviteOnly && defaultRole && inviteOnlyMessages[defaultRole]) {
    ...
    return (
      <div className="grid gap-7 p-7 sm:p-9 w-full max-w-[480px] mx-auto text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 min-h-[50px] px-6 rounded-xl text-[15px] font-semibold no-underline transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg bg-[#eb6651] text-white hover:bg-[#d45441]"
        >
          ...
          {roleOptions.map((role) => {
            ...
            return (
              <button
                ...
                className="group text-left w-full min-h-[120px] rounded-xl p-5 cursor-pointer transition-all duration-[280ms] hover:-translate-y-0.5 hover:shadow-[0_16px_45px_rgba(16,24,40,0.1)] border border-border bg-card hover:bg-accent hover:border-border"
              >
                <div className="flex items-start gap-4">
                  <div
                    className="shrink-0 size-12 rounded-xl flex items-center justify-center bg-accent border border-border"
                  >
