      ...
      <form action={action} className="grid gap-5 p-7 sm:p-9">
        ...
        <div className="grid gap-2">
          ...
          <Input
            ...
            required
            className="min-h-[48px] bg-card border border-border focus:border-coral focus:ring-2 focus:ring-coral/30 transition-all duration-200"
          />
        ...
        <Button
          ...
          disabled={pending}
          size="lg"
          className="min-h-[52px] w-full text-[15px] font-semibold transition-all duration-200 cursor-pointer bg-coral text-white hover:bg-coral/90 hover:translate-y-[-1px] hover:shadow-lg disabled:opacity-56 disabled:pointer-events-none"
        >
