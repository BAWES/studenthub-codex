...
// ---------------------------------------------------------------------------
// ReportData type and HTML builder for the candidate evaluation PDF route
// ---------------------------------------------------------------------------
...
/**
 * Build the full HTML report page for a candidate evaluation.
 * All user-provided text (candidateName, staffName, etc.) is HTML-escaped
 * before insertion to prevent XSS in the rendered HTML/PDF output.
 */
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header-info dt { font-weight: 600; color: #555; }
    .header-info dd { color: #333; }
    table {
      width: 100%;
