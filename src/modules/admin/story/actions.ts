...
export async function getStoryDetail(
  ...
  const parsed = storyItemSchema.safeParse(item);
  if (!parsed.success) {
    console.error(
      "[admin/story] getStoryDetail output validation failed:",
      parsed.error.issues,
    );
    return null;
  }
...
export async function listStories(
  ...
  if (!outputParsed.success) {
    console.error(
      "[admin/story] listStories output validation failed:",
...
export async function createStory(
  ...
  try {
    ...
    return {
      operation: "error",
      message:
        "Failed to create story. The request UUID may be invalid.",
    };
  }
}
...
export async function deleteStory(
  ...
  try {
    ...
    return {
      operation: "error",
      message:
        "Failed to delete story. It may have related records.",
    };
  }
}
