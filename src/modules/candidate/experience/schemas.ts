...
// ---------------------------------------------------------------------------
// Types — manual definitions for exact API shape
// ---------------------------------------------------------------------------
...
export type ExperienceItemOutput = z.output<typeof experienceItemOutputSchema>;
export type ExperienceActionResultOutput = z.output<typeof experienceActionResultOutputSchema>;
