...
export default function LandingContent({ session }: LandingContentProps) {
  return (
    <main className="min-h-svh w-[min(1320px,calc(100%_-_28px))] mx-auto grid content-start gap-4 pt-[18px] pb-[42px] max-sm:w-[min(calc(100%_-_20px),720px)]">
      ...
      <section
        className="relative min-h-[min(760px,calc(100svh_-_96px))] grid grid-cols-1 items-center overflow-hidden rounded-xl p-[clamp(22px,5vw,76px)] max-lg:min-h-auto max-lg:p-7"
      ...
      >
        ...
        {/* Floating app mockup */}
        <div
          className="absolute inset-0 grid place-items-center place-content-end p-[clamp(20px,4vw,58px)] opacity-[0.92] max-lg:relative max-lg:min-h-[360px] max-lg:order-2 max-lg:p-0 max-lg:pt-[18px]"
          aria-hidden="true"
        >
          <div className="shHeroMockup">
            <div
              className="grid content-start gap-2 p-3 rounded-lg"
              style={{
            ...
            <div
              className="grid content-start gap-2.5 p-3.5 rounded-lg"
              style={{
                background: "var(--sh-glass-bg)",
                border: "1px solid var(--sh-glass-border)",
              }}
            >
              <div
                className="min-h-[170px] grid content-end gap-2 rounded-lg p-[18px]"
                style={{
            ...
            <div
              className="grid content-end gap-2 p-4 rounded-lg max-lg:hidden"
              style={{
                background: "var(--sh-glass-bg)",
                border: "1px solid var(--sh-glass-border)",
              }}
            >
              ...
              <strong className="text-[22px] leading-[1.08]" style={{ color: "var(--ink)" }}>
      ...
      {/* ── Platform stats bar ── */}
      <section
        className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 p-6 rounded-xl"
        style={{
          background: "var(--sh-glass-bg)",
          border: "1px solid var(--sh-glass-border)",
        }}
      ...
      >
        {platformStats.map((stat) => {
          ...
          return (
            <div
              key={stat.label}
              className="flex items-center gap-3 max-sm:flex-col max-sm:text-center"
            >
              <Icon
