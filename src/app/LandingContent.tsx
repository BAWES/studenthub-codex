...
import {
  ...
  Clock, Zap, Shield, ChevronRight, Eye, CreditCard
} from "lucide-react";
...
function Testimonials({ persona }: { persona: Persona }) {
  ...
  return (
    <section id="testimonials" className="py-16 sm:py-20 px-6 max-w-6xl mx-auto">
      <Reveal>
        <h2 className="text-xl sm:text-2xl font-bold text-center mb-10" style={{ color: "var(--ink)" }}>Trusted by students and employers</h2>
      </Reveal>
