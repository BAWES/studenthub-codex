...
import { buildCvHtml } from "@/modules/candidate-id-cards/cv-helpers";
import { getCvPdfData } from "@/modules/candidate-id-cards/cv-actions";
 ...
 *
 * Renders a candidate CV as a professional PDF.
