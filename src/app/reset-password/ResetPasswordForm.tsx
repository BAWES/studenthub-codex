        ...
        return (
          <span
            ...
            className={`inline-flex items-center gap-1.5 text-xs ${
              met ? "text-[var(--sh-success)]" : "text-[var(--muted)]"
...
function SkeletonCard() {
  return (
    <div className="px-7 pb-7 max-md:px-5 max-md:pb-5">
      <div className="grid gap-3">
        <div className="h-4 w-full rounded bg-[var(--surface-soft)] animate-pulse" />
        <div className="h-4 w-[80%] rounded bg-[var(--surface-soft)] animate-pulse" />
        <div className="h-4 w-[45%] rounded bg-[var(--surface-soft)] animate-pulse" />
      </div>
    </div>
  );
}
...
export function ResetPasswordForm({ token }: Props) {
  ...
  if (tokenState.error && !tokenState.expired) {
    return (
      <div className="px-7 pb-7 max-md:px-5 max-md:pb-5">
        <div className="grid gap-5 text-center px-6 py-8 animate-[shLoginFormIn_500ms_var(--sh-easing)_both]">
          ...
          <div className="grid gap-1">
            <h2 className="text-[var(--fs-h3)] font-bold text-[var(--ink)] m-0">Invalid link</h2>
    ...
    return (
      <div className="px-7 pb-7 max-md:px-5 max-md:pb-5">
        <div className="grid gap-5 text-center px-6 py-8 animate-[shLoginFormIn_500ms_var(--sh-easing)_both]">
          ...
          <div className="grid gap-1">
            <h2 className="text-[var(--fs-h3)] font-bold text-[var(--ink)] m-0">Link expired</h2>
            <p className="text-[var(--fs-body)] text-[var(--muted)] leading-relaxed">
    ...
    return (
      <div className="px-7 pb-7 max-md:px-5 max-md:pb-5">
        <div className="grid gap-5 text-center px-6 py-8 animate-[shLoginFormIn_500ms_var(--sh-easing)_both]">
          ...
          <div className="grid gap-1">
            <h2 className="text-[var(--fs-h3)] font-bold text-[var(--ink)] m-0">Password reset successfully</h2>
            <p className="text-[var(--fs-body)] text-[var(--muted)] leading-relaxed">
