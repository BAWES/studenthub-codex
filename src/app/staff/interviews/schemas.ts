...
export type GetStaffInterviewDetailInput = z.input<typeof getStaffInterviewDetailSchema>;
export type UpdateInterviewStatusInput = z.input<typeof updateInterviewStatusSchema>;
...
// ---------------------------------------------------------------------------
// Form state / display helpers
// ---------------------------------------------------------------------------

export function formatInterviewDate(d: Date | null | undefined): string {
...
export function interviewStatusLabel(status: number | null | undefined): string {
