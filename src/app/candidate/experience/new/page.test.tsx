...
vi.mock("./ExperienceNewForm", () => ({
  ExperienceNewForm: () => <div data-testid="experience-new-form" />,
}));
...
describe("CandidateExperienceNewPage", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("renders WorkspaceShell with correct eyebrow and title", async () => {
    ...
    expect(screen.getByTestId("title")).toHaveTextContent("Add Work Experience");
  });

  it("renders the ExperienceNewForm component", async () => {
    const Page = (await import("./page")).default;
    render(await Page());

    expect(screen.getByTestId("experience-new-form")).toBeDefined();
  });
