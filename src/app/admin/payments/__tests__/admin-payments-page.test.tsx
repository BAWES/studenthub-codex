...
vi.mock("../payment-metric-cards", () => ({ PaymentMetricCards: vi.fn(() => <div data-testid="payment-metric-cards" />) }));
vi.mock("../payment-filters", () => ({ PaymentFilters: vi.fn(() => <div data-testid="payment-filters" />) }));
vi.mock("../payment-data-table", () => ({ PaymentDataTable: vi.fn(() => <div data-testid="payment-data-table" />) }));
vi.mock("../payment-detail-drawer", () => ({ PaymentDetailDrawer: vi.fn(() => <div data-testid="payment-detail-drawer" />) }));
vi.mock("../actions", () => ({
