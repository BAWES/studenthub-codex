...
export function AdminDegreeTable({ session, degrees }: Props) {
  ...
  return (
    ...
    >
      ...
      <DataTable
        title="Degrees"
        description="All degrees. Click a row to edit or delete."
