...
vi.mock("../invoice-metric-cards", () => ({ InvoiceMetricCards: vi.fn(() => <div data-testid="invoice-metric-cards" />) }));
vi.mock("../invoice-filters", () => ({ InvoiceFilters: vi.fn(() => <div data-testid="invoice-filters" />) }));
vi.mock("../invoice-data-table", () => ({ InvoiceDataTable: vi.fn(() => <div data-testid="invoice-data-table" />) }));
vi.mock("../invoice-detail-drawer", () => ({ InvoiceDetailDrawer: vi.fn(() => <div data-testid="invoice-detail-drawer" />) }));
vi.mock("../actions", () => ({
