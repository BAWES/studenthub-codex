          ...
          <div className="grid gap-2">
            ...
            {latest ? (
              <Link
                ...
                className="mt-2"
              >
                <Button variant="default" className="bg-coral hover:bg-coral/90">
            ...
            {[
              ...
              <Card key={step} className="border border-border bg-muted/30">
                <CardContent className="p-4 grid gap-1.5">
                  <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-coral text-white text-sm font-bold">
                    {step}
                  </span>
