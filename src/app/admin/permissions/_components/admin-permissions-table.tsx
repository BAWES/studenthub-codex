    ...
    >
      <div className="grid gap-1">
        ...
        <input
          ...
          className="h-9 rounded-lg border px-3 text-sm bg-[var(--surface)] border-border text-[var(--ink)]"
        />
      </div>
      <button
        type="submit"
  ...
  return (
    <form action={action} className="flex items-center gap-2">
      <input
        ...
        required
        maxLength={255}
        className="h-8 w-40 rounded border px-2 text-sm bg-[var(--surface)] border-border text-[var(--ink)]"
      />
      <button
        type="submit"
        disabled={pending}
