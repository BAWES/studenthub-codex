            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4">
                {statusMix.map((status) => (
                  <div
                    key={status.label}
                    className="flex items-center justify-between rounded-md px-3 py-2 text-sm bg-accent"
                  >
                    <span className="text-foreground">{status.label}</span>
                    <strong className="text-primary">{status.value}</strong>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
              {prMergeMetrics.map((metric, idx) => (
                ...
                >
                  ...
                  <div className="mt-1 text-lg font-bold text-primary">{metric.value}</div>
                  {metric.note && (
