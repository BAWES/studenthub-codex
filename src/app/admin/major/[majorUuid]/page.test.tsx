...
vi.mock("@/modules/workspace/WorkspaceShell", () => ({
  WorkspaceShell: ({
    children, eyebrow, title, metrics,
  }: {
    children: React.ReactNode; eyebrow: string; title: string;
    metrics: { label: string; value: string | number; note: string }[];
  }) =>
    React.createElement("div", { "data-testid": "workspace-shell" },
      React.createElement("div", { "data-testid": "eyebrow" }, eyebrow),
      React.createElement("div", { "data-testid": "title" }, title),
      ...metrics.map((m) =>
        React.createElement("span", { key: m.label, "data-testid": `metric-${m.label}` }, String(m.value))
      ),
      children,
    ),
}));
...
vi.mock("@/modules/workspace/DetailPanels", () => ({
  DetailSection: ({ title, facts }: {
    ...
    React.createElement("div", { "data-testid": "detail-section" },
      React.createElement("div", { "data-testid": "section-title" }, title),
      ...facts.map((f) =>
        React.createElement("span", { key: String(f.label), "data-testid": `fact-${f.label}` }, String(f.value))
      ),
    ),
}));
