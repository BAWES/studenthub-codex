  ...
  return (
    ...
    >
      <div className="grid gap-1">
        <label className="text-xs font-medium text-muted-foreground">Request UUID *</label>
        <input name="requestUuid" required placeholder="e.g. req-abc-123"
          className="h-9 rounded-lg px-3 text-sm border w-56 bg-card border-border text-foreground" />
      </div>
      <div className="grid gap-1">
        ...
        <input name="staffId" type="number" placeholder="Optional"
          className="h-9 rounded-lg px-3 text-sm border w-24 bg-card border-border text-foreground" />
      </div>
      <div className="grid gap-1">
  ...
  return (
    <form action={action} className="flex items-center gap-2 flex-wrap">
      ...
      <input name="staffId" type="number" defaultValue={row.staff_id ?? ""} placeholder="Staff ID"
        className="h-8 rounded px-2 text-sm border w-24 bg-card border-border text-foreground" />
