    ...
    >
      ...
      <div className="grid gap-1">
        ...
        <input
          ...
          type="number"
          placeholder="Optional"
          className="h-9 rounded-lg px-3 text-sm border bg-card border-border text-foreground w-28"
        />
      </div>
      <div className="grid gap-1">
      ...
      <div className="grid gap-1">
        ...
        <input
          ...
          maxLength={3}
          placeholder="e.g. WIR"
          className="h-9 rounded-lg px-3 text-sm border bg-card border-border text-foreground w-20"
        />
      </div>
      <button
        type="submit"
  ...
  return (
    <form action={action} className="flex items-center gap-2 flex-wrap">
      <input
        ...
        maxLength={100}
        className="h-8 rounded px-2 text-sm border bg-card border-border text-foreground w-36"
      />
      <input
        name="bankIbanCode"
        ...
        maxLength={64}
        placeholder="IBAN"
        className="h-8 rounded px-2 text-sm border bg-card border-border text-foreground w-48"
      />
      <input
        name="bankSwiftCode"
        ...
        maxLength={100}
        placeholder="SWIFT"
        className="h-8 rounded px-2 text-sm border bg-card border-border text-foreground w-28"
      />
      <input
        name="bankCodeAbk"
        type="number"
        ...
        placeholder="ABK"
        className="h-8 rounded px-2 text-sm border bg-card border-border text-foreground w-20"
      />
      <input
        name="bankAddress"
      ...
      <input
        ...
        maxLength={3}
        placeholder="Type"
        className="h-8 rounded px-2 text-sm border bg-card border-border text-foreground w-16"
      />
      <button
        type="submit"
        disabled={pending}
