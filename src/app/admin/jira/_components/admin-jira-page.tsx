      ...
      <div className="mb-4 flex gap-2">
        <button
          ...
          className={`text-xs px-3 py-1.5 rounded-md transition-all duration-200 border border-[var(--border)] ${
            tab === "issues" ? "bg-[var(--accent)] text-white" : "bg-[var(--surface)] text-[var(--ink)]"
          }`}
        >
          Issues
        </button>
        <button
          ...
          className={`text-xs px-3 py-1.5 rounded-md transition-all duration-200 border border-[var(--border)] ${
            tab === "users" ? "bg-[var(--accent)] text-white" : "bg-[var(--surface)] text-[var(--ink)]"
          }`}
        >
          Users
        </button>
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              ...
              render: (row) => (
                <span
                  className="text-xs px-2 py-0.5 rounded-full text-[var(--sh-success)]"
                  style={{
                    background:
