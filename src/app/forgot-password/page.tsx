          ...
          <div className="flex flex-wrap gap-2 mt-[18px] max-md:hidden">
            {["Encrypted tokens", "One-time use", "15 min expiry"].map(
              (item) => (
                <span
                  key={item}
                  className="min-h-[32px] inline-flex items-center px-3 rounded-full text-[11px] font-black uppercase tracking-[0.03em] bg-coral-light border border-coral/20 text-coral"
                >
                  {item}
                </span>
              )
