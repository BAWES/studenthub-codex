  ...
  return (
    <>
      ...
      >
        ...
        <Card className="relative overflow-hidden p-[clamp(24px,5vw,48px)]" aria-label="Admin pain points and solutions">
          ...
          <div className="relative z-[2]">
            ...
            <h2 className="text-[clamp(22px,3.4vw,38px)] font-extrabold leading-[1.08] tracking-tight mb-8">
              ...
              <br />
              You need a{" "}
              <em className="text-info not-italic">single</em>{" "}
              source of truth.
            </h2>
        ...
        <Card className="p-[clamp(20px,4vw,40px)] grid grid-cols-2 sm:grid-cols-4 gap-6 text-center" aria-label="Admin stats">
        ...
        <Card className="relative overflow-hidden p-[clamp(24px,5vw,60px)] text-center" aria-label="Get started as admin">
          <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#fef1ef] via-white to-background z-0" aria-hidden="true" />
