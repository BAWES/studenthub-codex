      ...
      <DataTablePage
        ...
        actions={
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-[var(--sh-coral)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--sh-coral-hover)] transition-colors"
          >
            + New Job Posting
          </Link>
        }
