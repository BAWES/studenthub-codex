...
export function JobEditForm({ job, readOnly }: Props) {
  ...
  const inputClass = readOnly
    ...
    : "w-full rounded-lg border border-input bg-card px-4 py-2.5 text-sm outline-none focus:border-coral focus:ring-1 focus:ring-coral/30";
  const textareaClass = readOnly
    ...
    : "w-full rounded-lg border border-input bg-card px-4 py-2.5 text-sm outline-none focus:border-coral focus:ring-1 focus:ring-coral/30 min-h-[80px]";
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className={readOnly
            ...
            : "w-full rounded-lg border border-input bg-card px-4 py-2.5 text-sm outline-none focus:border-coral focus:ring-1 focus:ring-coral/30 min-h-[120px]"}
