          ...
          >
            ...
            <form ref={formRef} onSubmit={(e) => { e.preventDefault(); handleConfirm(); }}>
              ...
              <textarea
                ...
                rows={4}
                className={`w-full rounded-lg border px-3 py-2 text-sm resize-none transition-colors focus:outline-none focus:ring-2 bg-card text-foreground outline-[var(--accent)] ${
