    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            <h3 className="text-base font-semibold mb-1 text-[var(--ink)]">
              Reject Application
            </h3>
            ...
            <form ref={formRef} onSubmit={(e) => { e.preventDefault(); handleConfirm(); }}>
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-lg border px-3 py-2 text-sm resize-none transition-colors focus:outline-none focus:ring-2 bg-[var(--surface)] text-[var(--ink)] outline-[var(--accent)]"
              ...
              <div className="flex justify-end gap-3 mt-4">
                <button
                  ...
                  disabled={submitting}
                  className="inline-flex items-center h-9 rounded-lg px-4 text-sm font-medium transition-colors disabled:opacity-50 bg-[var(--surface)] text-[var(--ink)]"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center h-9 rounded-lg px-4 text-sm font-semibold transition-colors disabled:opacity-50 bg-destructive text-white"
                >
