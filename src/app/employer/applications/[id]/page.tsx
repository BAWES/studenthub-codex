...
function DetailRow({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-start gap-4 py-3">
      <dt className="w-32 shrink-0 text-sm font-medium text-muted-foreground pt-0.5">
        {label}
      </dt>
        ...
        <div className="space-y-4">
          ...
          {canAcceptReject && (
            <div className="flex gap-3">
              <form action={acceptApplication}>
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 h-10 rounded-lg px-5 text-sm font-semibold text-white bg-accent transition-colors"
                >
                  Accept Application
                </button>
              </form>
              <form action={rejectApplication}>
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 h-10 rounded-lg px-5 text-sm font-semibold text-white bg-destructive transition-colors"
                >
                  Reject Application
                </button>
              </form>
          ...
          {canRevert && (
            <form action={revertApplicationStatus}>
              ...
              <button
                type="submit"
                className="inline-flex items-center gap-2 h-10 rounded-lg px-5 text-sm font-semibold text-foreground bg-card transition-colors"
              >
                Revert to Reviewing
              </button>
            </form>
          ...
          <div className="flex gap-3 pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 h-10 rounded-lg px-4 text-sm font-semibold text-foreground bg-card transition-colors"
            >
