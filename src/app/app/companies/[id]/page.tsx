...
import { getCompanyDetail, getCompanyAccountDetail } from "@/modules/workspace/data";
import { formatDate } from "@/modules/workspace/format";

export const dynamic = "force-dynamic";

export default async function AppCompanyDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (session.role === "staff") {
    ...
    redirect(`/app/companies?candidate=${candidateId}&tabs=${candidateId}`);
  }
