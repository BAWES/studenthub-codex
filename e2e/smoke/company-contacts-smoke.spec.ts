// ---------------------------------------------------------------------------
// E2E Smoke: Company contacts page
//
...
test.describe("Company contacts page", () => {
  ...
  test("company contacts page loads without errors", async () => {
  ...
  test("company contacts page renders table or heading", async () => {
    const ctx = await authContext(company);
    await ctx.page.goto("/company/contacts");
    await ctx.page.waitForLoadState("load");
