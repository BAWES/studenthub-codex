...
test.describe("Admin smoke — reports, requests", () => {
...
test.describe("Admin smoke — stores, tags", () => {
  test.describe.configure({ mode: "serial" });
...
test.describe("Admin smoke — tickets, user-requests", () => {
  test.describe.configure({ mode: "serial" });
  ...
  const pages = [
    ...
    { path: "/admin/user-requests", name: "User Requests" },
  ];
