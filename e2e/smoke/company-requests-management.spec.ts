// ---------------------------------------------------------------------------
// E2E Smoke: Company requests management page
//
...
test.describe("Company requests management page", () => {
  ...
  test("company requests page loads without errors", async () => {
  ...
  test("company requests page renders list or heading", async () => {
    const ctx = await authContext(company);
    await ctx.page.goto("/company/requests");
    await ctx.page.waitForLoadState("load");
