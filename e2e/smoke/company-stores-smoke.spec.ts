...
test.describe("Company stores page", () => {
  ...
  test("company stores page loads without errors", async () => {
  ...
  test("company stores page renders table or heading", async () => {
    const ctx = await authContext(company);
    await ctx.page.goto("/company/stores");
    await ctx.page.waitForLoadState("load");
