// ---------------------------------------------------------------------------
// E2E Smoke: Candidate payments page
//
...
test.describe("Candidate payments page", () => {
  ...
  test("payments page loads without errors", async () => {
  ...
  test("payments page renders heading or transaction list", async () => {
    const ctx = await authContext(candidate);
    await ctx.page.goto("/candidate/payments");
    await ctx.page.waitForLoadState("load");
