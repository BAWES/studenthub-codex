// ---------------------------------------------------------------------------
// E2E Smoke: Staff contracts page
//
...
test.describe("Staff contracts page", () => {
  ...
  test("staff contracts page loads without errors", async () => {
  ...
  test("staff contracts page renders list or heading", async () => {
    const ctx = await authContext(staff);
    await ctx.page.goto("/staff/contracts");
    await ctx.page.waitForLoadState("load");
