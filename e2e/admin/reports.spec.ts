// ---------------------------------------------------------------------------
// E2E Smoke: Admin Reports and analytics
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin reports page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin reports page", () => {
  ...
  test("admin reports page loads without errors", async () => {
    await assertPageLoads("/admin/reports");
  });
});
