// ---------------------------------------------------------------------------
// E2E Smoke: Admin Employee management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin employees page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin employees page", () => {
  ...
  test("admin employees page loads without errors", async () => {
    await assertPageLoads("/admin/employees");
  });
});
