// ---------------------------------------------------------------------------
// E2E Smoke: Admin AWS configuration
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin aws page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin aws page", () => {
  ...
  test("admin aws page loads without errors", async () => {
    await assertPageLoads("/admin/aws");
  });
});
