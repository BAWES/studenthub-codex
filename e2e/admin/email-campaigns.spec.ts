// ---------------------------------------------------------------------------
// E2E Smoke: Admin Email Campaigns management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin email-campaign page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin email-campaign page", () => {
  ...
  test("admin email-campaign page loads without errors", async () => {
    await assertPageLoads("/admin/email-campaign");
  });
});
