// ---------------------------------------------------------------------------
// E2E Smoke: Admin Bank account management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin bank page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin bank page", () => {
  ...
  test("admin bank page loads without errors", async () => {
    await assertPageLoads("/admin/bank");
  });
});
