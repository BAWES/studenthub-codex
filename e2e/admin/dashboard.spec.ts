// ---------------------------------------------------------------------------
// E2E Smoke: Admin dashboard
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin dashboard page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin dashboard page", () => {
  ...
  test("admin dashboard page loads without errors", async () => {
    await assertPageLoads("/admin/dashboard");
  });
});
