// ---------------------------------------------------------------------------
// E2E Smoke: Admin Degree Group management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin degree-group page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin degree-group page", () => {
  ...
  test("admin degree-group page loads without errors", async () => {
    await assertPageLoads("/admin/degree-group");
  });
});
