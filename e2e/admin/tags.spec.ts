// ---------------------------------------------------------------------------
// E2E Smoke: Admin Tag management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin tags page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin tags page", () => {
  ...
  test("admin tags page loads without errors", async () => {
    await assertPageLoads("/admin/tags");
  });
});
