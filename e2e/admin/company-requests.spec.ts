// ---------------------------------------------------------------------------
// E2E Smoke: Admin company-requests management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin company-requests page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin company-requests page", () => {
  ...
  test("admin company-requests page loads without errors", async () => {
    await assertPageLoads("/admin/company-requests");
  });
});
