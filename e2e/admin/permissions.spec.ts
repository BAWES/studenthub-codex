// ---------------------------------------------------------------------------
// E2E Smoke: Admin Permission and role management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin permissions page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin permissions page", () => {
  ...
  test("admin permissions page loads without errors", async () => {
    await assertPageLoads("/admin/permissions");
  });
});
