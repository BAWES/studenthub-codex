// ---------------------------------------------------------------------------
// E2E Smoke: Admin Compliance and regulations
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin compliance page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin compliance page", () => {
  ...
  test("admin compliance page loads without errors", async () => {
    await assertPageLoads("/admin/compliance");
  });
});
