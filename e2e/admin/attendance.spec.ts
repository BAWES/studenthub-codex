// ---------------------------------------------------------------------------
// E2E Smoke: Admin Attendance tracking
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin attendance page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin attendance page", () => {
  ...
  test("admin attendance page loads without errors", async () => {
    await assertPageLoads("/admin/attendance");
  });
});
