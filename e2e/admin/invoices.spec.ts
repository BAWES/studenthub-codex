// ---------------------------------------------------------------------------
// E2E Smoke: Admin Invoice management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin invoices page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin invoices page", () => {
  ...
  test("admin invoices page loads without errors", async () => {
    await assertPageLoads("/admin/invoices");
  });
});
