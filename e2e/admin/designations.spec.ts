// ---------------------------------------------------------------------------
// E2E Smoke: Admin Designation management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin designations page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin designations page", () => {
  ...
  test("admin designations page loads without errors", async () => {
    await assertPageLoads("/admin/designations");
  });
});
