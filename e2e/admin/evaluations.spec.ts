// ---------------------------------------------------------------------------
// E2E Smoke: Admin Evaluations management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin evaluations page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin evaluations page", () => {
  ...
  test("admin evaluations page loads without errors", async () => {
    await assertPageLoads("/admin/evaluations");
  });
});
