// ---------------------------------------------------------------------------
// E2E Smoke: Admin Department management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin departments page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin departments page", () => {
  ...
  test("admin departments page loads without errors", async () => {
    await assertPageLoads("/admin/departments");
  });
});
