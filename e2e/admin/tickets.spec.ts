// ---------------------------------------------------------------------------
// E2E Smoke: Admin Ticket management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin tickets page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin tickets page", () => {
  ...
  test("admin tickets page loads without errors", async () => {
    await assertPageLoads("/admin/tickets");
  });
});
