// ---------------------------------------------------------------------------
// E2E Smoke: Admin University management
//
// CI only. Uses USE_MOCK_FIXTURES=true.
// Verifies the admin university page loads without errors.
// ---------------------------------------------------------------------------
...
test.describe("Admin university page", () => {
  ...
  test("admin university page loads without errors", async () => {
    await assertPageLoads("/admin/university");
  });
});
