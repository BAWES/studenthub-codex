...
- `npm run test:smoke`
  ...
  - Checks the shared admin/staff/candidate candidate workspace renders from prod-clone data, full candidate detail pages expose readiness, and staff get an unavailable preview for unassigned candidates.
